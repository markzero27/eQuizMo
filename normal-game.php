 ...
 <!-- Navigation-->
    ...
    <div class="container-fluid">     
      ...
      <div class=" bg-transparent " id="main" >
        ...
        <div class="row">
            <div class="col ml-5"><label>Questions</label></div>
            <div class="col row ">
                 <div class="col "><label>Answer</label></div> 
        ...
        <?php 
            ...
            if($type=="Random Quiz" || $type=="Custom Quiz"){
                 $where = array(
                    "difficulty" => $diff,
                    "is_selected" => 1
                    );
        ...
        <div class="row under">
            ...
            <div class="col text-left ml-5 ">
               <label class="fade-scroll qlabel text-truncate"><?php echo $row['q_sequence'].". ".$row['category']." - ". $row['question']; ?></label>
            </div> 
