    ...
    <div class="container-fluid">     
      ...
      <div class="" >
            ...
            <table class="table table-striped table-dark mt-2">
               <thead>
                   <tr><th class="text-center" colspan="13"><h1>Result</h1></th></tr>
                    <tr>
        ...
        <?php 
            ...
            $x=0;
            $prev_sc = 0;
            $sql = "SELECT team, SUM(score) as total FROM points_table WHERE game_id = '".$game_id."' and type != 'Tie-Breaker' GROUP BY team ORDER BY total DESC";
            ...
            ?>      <tr>
                        <td class="text-center"><?php echo $x;?>
                            </td>
