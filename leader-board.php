...
if($right=="Total"){
    $linkR = "leader-board-result.php?msg=";
    $linkL = "leader-board.php?diff=";
}else{
    $linkR = "leader-board.php?diff=";
    $linkL = "leader-board.php?diff=";
}
      ...
      <div id="main" class="content-wrapper bg-secondary">
        <div class="container-fluid">  
            ...
            <table class="table table-striped table-dark mt-2">
               <thead>
                   <tr><th class="text-center" colspan="13"><h1><a href="<?php echo $linkL.$left; ?>" title="<?php echo $left; ?>" class="mr-5"><i class='fa fa-angle-left text-dark'></i></a>Leader Board<a href="<?php echo $linkR.$right;?>" title="<?php echo $right; ?>" class="ml-5"><i class='fa fa-angle-right text-dark'></i></a></h1></th></tr>
                    <tr>
